...
class IotAdaptor {
    ...
    connect() {
        ...
        this.device = deviceModule({
            keyPath: path.resolve(__dirname, this.config.privateKey),
            certPath: path.resolve(__dirname, this.config.clientCert),
            caPath: path.resolve(__dirname, this.config.caCert),
